...
class Upload
{
    ...
    /**
     * Método responsável por validar extensão prérequisitada
     * @param array $extension
     * @return boolean
     */
    private function extensionValidate($extension)
    {

        // VERIFICANDO PRÉREQUISITOS
        if (empty($extension)) return true;

        // VALIDANDO EXTENSÃO
        return in_array($this->extension, $extension);
    }
     ...
     * @return boolean
     */
    public function upload($dir, $overwrite = true, $extension = [])
    {
        ...
        // VALIDANDO EXTENSÃO
        if ($this->extensionValidate($extension) != true) return false;
